    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/users/register", "/api/users/register-simple", "/api/users/login", "/api/users/health",
                                "/api/users/forgot-password")
                        .permitAll()
                        .requestMatchers("/api/rides/search", "/api/rides/all", "/api/payments/**", "/api/payment/**",
                                "/api/payments/confirm-payment/**", "/api/payments/verify", "/payment-success",
                                "/payment-cancel")
                        .permitAll()
